...
export const getCategories = (): ValueFormatCategory[] => [
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'kilogram per cubic meter (kg/m³)', id: 'kgrampm3', fn: SIPrefix('g/m³', 1) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Megavolt-ampere (kVA)', id: 'Mvoltamp', fn: SIPrefix('VA', 2) },
      ...
      { name: 'Megavolt-ampere reactive (kvar)', id: 'Mvoltampreact', fn: SIPrefix('var', 2) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Kilowatt per square meter (kW/m²)', id: 'kWm2', fn: SIPrefix('kW/m²', 2) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'litres/minute (l/min)', id: 'lpmin', fn: SIPrefix('l/min') },
      { name: 'litres/hour (l/hr)', id: 'lphr', fn: SIPrefix('l/hr') },
      { name: 'kilogram/second (kg/s)', id: 'kgps', fn: SIPrefix('g/s', 1) },
      { name: 'kilogram/minute (kg/min)', id: 'kgpmin', fn: SIPrefix('g/min', 1) },
      { name: 'kilogram/hour (kg/hr)', id: 'kgphr', fn: SIPrefix('g/hr', 1) },
      { name: 'tonne/minute (t/min)', id: 'tonnepmin', fn: SIPrefix('t/min') },
      { name: 'tonne/hour (t/hr)', id: 'tonnephr', fn: SIPrefix('t/hr') },
      { name: 'cubic metres/second (m³/s)', id: 'm3ps', fn: SIPrefix('m³/s') },
      { name: 'cubic metres/second (m³/s) fixed', id: 'm3psf', fn: toFixedUnit('m³/s') },
      { name: 'kilo cubic metres/second (km³/s)', id: 'km3ps', fn: SIPrefix('km³/s', 1) },
      { name: 'cubic metres/min (m³/min)', id: 'm3pmin', fn: SIPrefix('m³/min') },
      { name: 'cubic metres/min (m³/min) fixed', id: 'm3pminf', fn: toFixedUnit('m³/min') },
      { name: 'cubic metres/hour (m³/hr)', id: 'm3phr', fn: SIPrefix('m³/hr') },
      { name: 'cubic metres/hour (m³/hr) fixed', id: 'm3phrf', fn: toFixedUnit('m³/hr') },
      { name: 'kilo cubic metres/hour (km³/hr)', id: 'km3phr', fn: SIPrefix('m³/hr', 1) },
      { name: 'normalised m³/second (Nm³/s)', id: 'Nm3ps', fn: SIPrefix('Nm³/ps') },
      { name: 'normalised m³/second (Nm³/s) fixed', id: 'Nm3psf', fn: toFixedUnit('Nm³/s') },
      { name: 'kilo normalsd m3/second (kNm³/s)', id: 'kNm3ps', fn: SIPrefix('kNm³/s', 1) },
      { name: 'normalised m³/minute (Nm³/min)', id: 'Nm3pmin', fn: SIPrefix('Nm³/min') },
      { name: 'normalised m³/minute (Nm³/min) fixed', id: 'Nm3pminf', fn: toFixedUnit('Nm³/min') },
      { name: 'normalised m³/hour (Nm³/hr)', id: 'Nm3phr', fn: SIPrefix('Nm³/hr') },
      { name: 'normalised m³/hour (Nm³/hr) fixed', id: 'Nm3phrf', fn: toFixedUnit('Nm³/hr') },
      { name: 'kilo normalsd m³/hour (kNmy/hr)', id: 'kNm3phr', fn: SIPrefix('Nm³/hr', 1) },
      { name: 'kilogram/rpm (kgm/rpm)', id: 'kgprpm', fn: SIPrefix('kgprpm', 1) },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'Millibarg', id: 'pressurembarg', fn: SIPrefix('bar', -1) },
      { name: 'Barg', id: 'pressurebarg', fn: SIPrefix('bar') },
      { name: 'Kilobarg', id: 'pressurekbarg', fn: SIPrefix('bar', 1) },
      { name: 'Newtons/square millimetre (N/mm²)', id: 'pressurenpmm2', fn: SIPrefix('N/mm²') },
  ...
  },
  {
    ...
    formats: [
      ...
      { name: 'cubic centimetre', id: 'cm3', fn: SIPrefix('cm³') },
